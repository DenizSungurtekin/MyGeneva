...
import { LieuEventsScreen } from './src/screens/LieuEventsScreen';
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={{ flex: 1 }}>
        ...
        {screen === 'lieu' && <PlacesListScreen />}
        {screen === 'lieuDetail' && <PlaceDetailScreen />}
        {screen === 'lieuEvents' && <LieuEventsScreen />}
